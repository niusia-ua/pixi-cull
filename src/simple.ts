import { AABB, DisplayObjectWithCulling } from './types';
...
export class Simple
{
     ...
     * @param {string} [options.dirtyTest=false] - only update the AABB box for objects with object[options.dirtyTest]=true;
